...
export const zh: Record<DictKey, string> = {
  ...
  "settings.compactTarget": "压缩目标",
  "settings.compactTargetHint": "压缩后保留的尾段对话占上下文窗口的比例。较低的值释放更多空间，但会丢失更多旧对话内容。",
  "settings.compactRatio": "压缩触发",
  "settings.compactRatioHint": "自动压缩触发的上下文窗口占比。较低的值会更早压缩，保持提示精简。",
  "orchestrator.title": "协调器",
  "orchestrator.planning": "规划中",
  "orchestrator.developing": "编码中",
  "orchestrator.reviewing": "审查中",
  "orchestrator.done": "完成",
  "orchestrator.currentTask": "当前",
  "orchestrator.planTree": "计划树",
  "orchestrator.reviewHistory": "审查记录",
  "orchestrator.review": "审查",
  "orchestrator.noReviews": "尚无审查",
  "settings.orchestrator": "协调器",
  "settings.orchestratorHint": "规划→开发→审查工作流。需在 Agent 设置中配置 planner_model。",
  "settings.orchestratorEnabled": "启用协调器",
  "settings.orchestratorEnabledHint": "开启后，规划-开发-审查流程将取代普通代理模式。",
  "settings.orchestratorReviewerModel": "审查模型",
  "settings.orchestratorReviewerModelHint": "在每个任务完成后审查开发者工作的模型。",
  "settings.orchestratorSecondReviewerModel": "第二审查者（可选）",
  "settings.orchestratorSecondReviewerModelHint": "可选的交叉检查审查者。其结果与主审查者合并——开发者仅在两者都通过时才进入下一任务。",
  "settings.orchestratorSecondReviewerModelNone": "无（单一审查者）",
  "settings.orchestratorMaxRetries": "最大重试次数",
  "settings.orchestratorMaxRetriesHint": "审查失败后开发者最多可重试的次数。",
  "settings.orchestratorAutoCommit": "自动提交变更",
  "settings.orchestratorAutoCommitHint": "启用后，开发者将在每个任务完成后自动 git commit，以便审查者有干净的 diff 可供检查。",
