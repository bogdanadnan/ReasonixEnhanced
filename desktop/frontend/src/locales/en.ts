...
export const en = {
  ...
  "settings.compactTarget": "Compact target",
  "settings.compactTargetHint": "The fraction of the context window the kept tail may occupy after compaction. Lower values free more space but lose more older context.",
  "settings.compactRatio": "Compact trigger",
  "settings.compactRatioHint": "The fraction of the context window at which auto-compaction fires. Lower values compact earlier, keeping the prompt lean.",
  "orchestrator.title": "Orchestrator",
  "orchestrator.planning": "Planning",
  "orchestrator.developing": "Coding",
  "orchestrator.reviewing": "Reviewing",
  "orchestrator.done": "Done",
  "orchestrator.currentTask": "Current",
  "orchestrator.planTree": "Plan tree",
  "orchestrator.reviewHistory": "Review history",
  "orchestrator.review": "Review",
  "orchestrator.noReviews": "No reviews yet",
  "settings.orchestrator": "Orchestrator",
  "settings.orchestratorHint": "Planner → Developer → Reviewer workflow. Requires planner_model in Agent config.",
  "settings.orchestratorEnabled": "Enable orchestrator",
  "settings.orchestratorEnabledHint": "When on, the planner-developer-reviewer workflow replaces the normal agent.",
  "settings.orchestratorReviewerModel": "Reviewer model",
  "settings.orchestratorReviewerModelHint": "Model that reviews the developer's work after each task.",
  "settings.orchestratorSecondReviewerModel": "Second reviewer (optional)",
  "settings.orchestratorSecondReviewerModelHint": "Optional cross-check reviewer. Its verdict is combined with the primary reviewer — the developer only advances when both pass.",
