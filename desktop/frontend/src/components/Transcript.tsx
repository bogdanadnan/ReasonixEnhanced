...
export const Transcript = memo(function Transcript({
  ...
  // Standard mode only — no step collapsing.
  ...
  // ── Hot zone: always flat (standard) rendering, no step collapsing ───────
  const hotZoneNodes = useMemo<ReactNode[]>(() => {
    ...
    return out;
  }, [hotStartIdx, items, openAction, actionPending, rewindDisabled, running, onRewind, subcallsByParent, userTurn, checkpointsByTurn, tabId]);
